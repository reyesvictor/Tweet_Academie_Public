...
<head>
    ...
    <script type='text/javascript' src="../../../js/settings/password.js"></script>
    <script type='text/javascript' src="../../../js/settings/pseudo.js"></script>
    <script type='text/javascript' src="../../../js/settings/email.js"></script>
        ...
        <div class="row">
            <div class="three columns">
                <!-- <div class="menu">
                    <h2>Pouletter</h2>
                    <ul>
                        <li><a href="home.php"><svg viewBox="0 0 24 24" class="logo-menu">
                                <g>
                        ...
                        <li><svg viewBox="0 0 24 24" class="logo-menu">
                                <g>
                        ...
                        <li><img src="../../css/img/moi.jpg">Profil</li>

                        <li><svg viewBox="0 0 20 20" class="logo-menu">
                                <g>
            ...
            <div class="nine columns">
                <div class="divPrincipale">
                    <div class="pseudoG">
                        <div class="option" id='change-pseudo'>
                            CHANGE USERNAME
                        </div>
                        <section class='option' style='margin-bottom: 0; display: none;' id='change-pseudo-input'>
                            <form id="new-pseudo-form" style='margin-bottom: 0;'>
                                <input type="text" name="pseudo" id="pseudo" value='<?php echo $pseudoUser[0]['username'] ?>' style='width: 50%; margin-bottom: 0;'>
                                <input type="submit" value="Confirmer" id="new-pseudo-submit" style='margin-bottom: 0;'>
                            </form>
                        </section>
                    </div>
                    <div class="emailG">
                        <div class="option" id='change-mail'>
                            CHANGE EMAIL
                        </div>
                        <section class='option' style='margin-bottom: 0; display: none;' id='change-mail-input'>
                            <form id="new-email-form" style='margin-bottom: 0;'>
                                <input type="password" name="password" id="password-mail" placeholder='Votre mot de passe' style='margin-bottom: 0;'>
                                <input type="email" name="new-email" id="new-email" placeholder='Nouveau email' style='margin-bottom: 0;'>
                                <input type='hidden' id='idMember-mail' value="<?php echo $idUser; ?>" style='margin-bottom: 0;'>
                                <input type="submit" value="Confirmer" id="new-email-submit" style='margin-bottom: 0;'>
                            </form>
                        </section>
                    </div>
                    <div class="mdpG">
                        <div class="option" id='change-pwd'>
                            CHANGE PASSWORD
                        </div>
                        <section class="option" style='margin-bottom: 0; display: none;' id='change-pwd-input'>
                            <form id="new-password-form" style='margin-bottom: 0;'>
                                <input type="password" name="password" id="password" placeholder='Mot de passe actuel' style='margin-bottom: 0;'>
                                <input type="password" name="new-password" id="new-password" placeholder='Nouveau mot de passe' style='margin-bottom: 0;'>
                                <input type="password" name="new-passwordConfirmation" id="new-passwordConfirmation" placeholder='Confirmer mot de passe' style='margin-bottom: 0;'>
                                <input type='hidden' id='idMember' value="<?php echo $idUser; ?>" style='margin-bottom: 0;'>
                                <input type="submit" value="Confirmer" id="new-password-submit" style='margin-bottom: 0;'>
                            </form>
                        </section>
                    </div>
                </div>
