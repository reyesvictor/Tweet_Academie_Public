...
<head>
  ...
  <meta charset="utf-8">
  <title>Following | Tweet Academy</title>
  ...
  <div class="container" id="container">
    ...
    <div class="six columns" id='container'>
      ...
      <div class="feedtabs row" id="tabs">
        <div class="feedtabs__following six columns selected" id="tabs_following-div">
          <a href="following.php" id="tabs_following" class='color-theme'>Following</a>
        </div>
        <div class="feedtabs__follower six columns" id="tabs_follower-div">
          <a href="followers.php" id="tabs_follower">Followers</a>
        </div>
      </div>
